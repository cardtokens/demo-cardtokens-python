...
#
# The public key extracted from Cardtokens backoffice. 
# Notice that this has been converted to a RSA public key using openssl
# openssl rsa -in pubkey.txt -out rsapublickey.pem -pubin -RSAPublicKey_out
# The value of rsapublickey.pem has then been base64 encoded with padding and added there to this demo parameter
#
